            ...
            <div className="w-full flex  justify-center ">
                <div className="w-5/6 opacity-90 border absolute backdrop-blur-sm bg-white/[0.6] h-fit p-2 flex-col sm:w-5/6 md:w-3/4 lg:w-1/2 rounded-xl animate-fall  translate-y-40 ">
                    ...
                    <form className="px-4 w-full mx-auto">
                        ...
                        <button type="submit" className="text-white mb-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
                    </form>
