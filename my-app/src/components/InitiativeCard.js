    ...
    return (
        <div className="md:w-3/4 mx-auto my-10 flex flex-col md:flex-row">
            ...
            <div className="flex w-full flex-col">
                ...
                <button className="bg-blue-800 text-white hover:scale-110 transition-transform duration-300 font-bold w-48 flex flex-row justify-between py-2 mx-5 px-4 rounded-full">
