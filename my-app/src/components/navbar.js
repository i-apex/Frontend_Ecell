          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
              ...
              <button
                ...
                type="button"
                className={`inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 ${isOpen ? 'animate-close' : ''}`}
            ...
            >
              <ul className="flex flex-col pb-3 md:p-0 mt-4 font-medium md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
                <li>
                  <Link to="/" className="block py-2 px-3 hover:text-blue-800">
                    Home
                  </Link>
                </li>
                <li>
                  <Link to="/Events" className="block py-2 px-3 hover:text-blue-800">
                    Events
                  </Link>
                </li>
                <li>
                  <Link to="/Innovations" className="block py-2 px-3 hover:text-blue-800">
                    Innovations
                  </Link>
                </li>
                <li>
                  <Link to="/Blogs" className="block py-2 px-3 hover:text-blue-800">
                    Blogs
                  </Link>
                </li>
                <li>
                  <Link to="/Team" className="block py-2 px-3 hover:text-blue-800 ">
                    Team
                  </Link>
                </li>
              </ul>
...
>>>>>>> 618c02327731b9e5aa03ec6088d826e2490bb003