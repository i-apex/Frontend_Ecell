...
{ Team_name: "Community Management Team", Team_members: [{ Name: "Abhishek Anand", Position: "Lead" }, { Name: "Hemashree", Position: "Core Member" }, { Name: "Anupam Tripathi", Position: "Core Member" }] }];
